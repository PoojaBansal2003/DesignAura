  ...
  return (
    <div className="home">
      <div className="homeNews" style={{ backgroundImage: `url(${photoBg})` }}>
        <h1>Design a Unique Living Space</h1>
        <p>
          Explore cutting-edge interior design ideas on our startup website, blending style with practicality.
        </p>
        <Link to="">
          <button>
            Get Started
      ...
      <div className="homeOther">
        ...
        <div className="homeAboutUs">
          <div className="hp-subtext">
            <h1>We Craft the Essence of Elegant Living with Style</h1>
            <p>
              Discover a realm where every detail is meticulously crafted to define the essence of elegant living. With our unique blend of style and sophistication, we transform spaces into refined sanctuaries that resonate with timeless charm and contemporary allure.
            </p>
        ...
        <div className="homeProjects">
          ...
          <p>
          Join us as we embark on a journey of innovation and creativity, exploring new horizons with every project we undertake.
          </p>
      ...
      <div className="articleNews">
        <h1>Articles & News</h1>
        <p>
        Stay informed and inspired with our latest articles and news, unveiling trends, tips, and insights to elevate your interior design experience.
        </p>
        <div className="articles">
          <div className="article nochosen" onClick={handleChange}>
            ...
            <div className="article-content">
              <p>Green Construction Trends: Sustainable Solutions Unveiled</p>
          ...
          <div className="article nochosen" onClick={handleChange}>
            ...
            <div className="article-content">
              <p>Community Impact: Construction Initiatives Changing Lives</p>
              <div className="ac-detail">
                <p className="ac-date">3 March 2023</p>
                <Link to={`/blog-details`}>
                  <button>
          ...
          <div className="article nochosen" onClick={handleChange}>
            ...
            <div className="article-content">
              <p>Innovative Construction Collaboration Announced</p>
              <div className="ac-detail">
                <p className="ac-date">3 March 2023</p>
                <Link to={`/blog-details`}>
                  <button>
      ...
      <div className="h-interno">
        <h1>Wanna join the DreamAura?</h1>
